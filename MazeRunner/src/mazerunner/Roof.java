 ...
 */
public class Roof extends GameObject implements VisibleObject{

	private static final float size = (float) Maze.SQUARE_SIZE;			// Roof size
	private static final float s = size/2;
	
	/**
	 * create a new roof object on the index coordinates
	 */
